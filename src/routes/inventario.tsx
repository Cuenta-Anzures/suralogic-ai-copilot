...
const chips = ["Todos", "Riesgo", "Lento", "Saludable", "Calzado", "Accesorios"];
...
function Inventario() {
  ...
  return (
    <AppShell
      greeting="Inventario inteligente"
      subtitle="5 SKUs monitoreados · 2 en riesgo · rotación general saludable."
    >
      {/* Search */}
